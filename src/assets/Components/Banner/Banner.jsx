    ...
    return (
        <div className="mt-8 lg:mt-14 bg-[url(/src/assets/images/banner.png)] bg-no-repeat bg-cover rounded-3xl mx-4 px-5 lg:px-20 mb-8 lg:mb-16">
            ...
            <div className="flex gap-4 justify-center items-center mt-5 lg:mt-10 pb-8 lg:pb-24">
                <button className="btn bg-green-400 font-bold border-0 rounded-full text-sm lg:text-lg text-white">Explore Now</button>
                <button className="btn bg-transparent text-white rounded-full text-sm lg:text-lg ">Our Feedback</button>
            </div>
        </div>
    );
};
