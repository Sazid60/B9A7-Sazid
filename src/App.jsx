...
import Cart from "./assets/Components/CartTop/CartTop"
  ...
  return (
    <>
      <div className="container mx-auto">
        ...
        <Banner></Banner>
        <div className="mx-4">
          <h1 className="text-2xl lg:text-3xl font-bold  text-center">Our Recipes</h1>
          <div className="flex justify-center items-center mt-6 text-center">
            <p className="max-w-[800px] mb-12 lg:text-xl">Explore our Recipe section, a culinary treasure trove where flavors mingle and inspiration thrives.</p>
          </div>
          <div className="lg:flex gap-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 lg:w-[60%] p-5 border-2 rounded-xl">
              <Recipes items={items}></Recipes>
            </div>
            <div className="lg:w-[60%] flex flex-col item-center border-2 p-6 rounded-xl">
              <h1 className="font-bold text-xl lg:text-2xl text-center lg:mb-6">Want to Cook : {0}</h1>
              <hr className="mb-8" />
              ...
              <div className="mt-12">
                ...
                <table className="table-auto w-full text-center ">
                  ...
                  <tbody className="text-center">
                    <tr>
                      <td className="text-xs lg:text-xl">{1}</td>
                ...
                <div className="mt-7 text-center lg:text-right lg:pr-14">
                  <h1 className="lg:text-xl font-bold"> Total Time: {45} Minutes </h1>
