      ...
      <div className="container mx-auto">
        ...
        <div className="mx-4">
          ...
          <div className="flex justify-center items-center mt-6 text-center">
            <p className="max-w-[800px] mb-6 lg:mb-12 text-sm lg:text-lg">Explore our Recipe section, a culinary treasure trove where flavors mingle and inspiration thrives. Discover a world of gastronomic delight and unleash your inner chef with our diverse array of mouthwatering recipes.</p>
          </div>
